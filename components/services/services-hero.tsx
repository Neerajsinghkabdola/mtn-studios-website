      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h1 className={cn(
            ...
            Creative & Digital Services <br className="hidden md:block" />
          ...
          <p className={cn(
            ...
            From brand identity to performance marketing, MTN Studios delivers integrated solutions that help brands scale.
          </p>
        </div>
      </div>
    </section>
